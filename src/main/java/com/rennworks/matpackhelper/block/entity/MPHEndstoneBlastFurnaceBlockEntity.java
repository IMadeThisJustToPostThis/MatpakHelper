...
public class MPHEndstoneBlastFurnaceBlockEntity extends AbstractFurnaceBlockEntity {

    public MPHEndstoneBlastFurnaceBlockEntity(BlockPos pos, BlockState state) {
        super(MPHBlockEntityTypes.ENDSTONE_BLAST_FURNACE.get(), pos, state, RecipeType.BLASTING);
    }
