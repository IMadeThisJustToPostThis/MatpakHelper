...
public class MPHDeepslateBlastFurnaceBlockEntity extends AbstractFurnaceBlockEntity {

    public MPHDeepslateBlastFurnaceBlockEntity(BlockPos pos, BlockState state) {
